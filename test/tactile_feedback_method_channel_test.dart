...
void main() {
  ...
  const tactileFeedbackChannel = BasicMessageChannel<Object?>(
    'dev.flutter.pigeon.tactile_feedback.TactileFeedbackApi.impact',
  ...
  group('MethodChannelTactileFeedback', () {
    ...
    group('impact', () {
      ...
      test(
        ...
        'TargetPlatform.android or TargetPlatform.macOS',
        () async {
      ...
      test(
        ...
        'when debugDefaultPlatform is TargetPlatform.iOS',
        () async {
      ...
      test(
        'calls HapticFeedback.mediumImpact() '
        'when debugDefaultPlatform is TargetPlatform.android',
        () async {
      ...
      test(
        ...
        'when debugDefaultPlatform is TargetPlatform.macOS',
        () async {
          debugDefaultTargetPlatformOverride = TargetPlatform.macOS;
            ...
            expect(
              ...
              isA<PlatformException>()
                  ...
                  .having(
                    (e) => e.message,
                    'message',
                    startsWith('Unable to establish connection on channel'),
                  ),
            );
          } finally {
            debugDefaultTargetPlatformOverride = null;
